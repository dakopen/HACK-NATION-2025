...
const TRENDS: Trend[] = [
    {
        ...
        coverUrl: "https://picsum.photos/seed/italian-brainrot/360/640",
    },
    {
        id: "npc-livestream",
        title: "NPC Livestream",
        description: "Scripted reactions and catchphrases like an NPC.",
        defaultHashtags: ["#npc", "#stream", "#trending"],
        coverUrl: "https://picsum.photos/seed/npc-livestream/360/640",
    },
    {
        id: "micd-up",
        title: "POV: You're mic'd up",
        description: "Behind-the-scenes commentary with captions.",
        defaultHashtags: ["#pov", "#behindthescenes", "#micdup"],
        coverUrl: "https://picsum.photos/seed/micdup/360/640",
    },
    {
        id: "subway-surfers",
        title: "Subway Surfers Overlay",
        description: "Gameplay overlay to keep attention while the message runs.",
        defaultHashtags: ["#subwaysurfers", "#overlay", "#ad"],
        coverUrl: "https://picsum.photos/seed/subway-surfers/360/640",
    },
    {
        id: "capcut-template",
        title: "CapCut Template du jour",
        description: "Use the latest CapCut visual trend format.",
        defaultHashtags: ["#capcut", "#template", "#trend"],
        coverUrl: "https://picsum.photos/seed/capcut-template/360/640",
    },
];
    ...
    return (
        <div className="panel">
            ...
            <div className="context-box">
                <label htmlFor="ctx">Company/context</label>
                <textarea
                    id="ctx"
                    value={companyContext}
                    onChange={(e) => onUpdateContext(e.target.value)}
                    placeholder="Describe your brand, product, audience, or notes..."
                    rows={4}
                />
            </div>

            <div className="actions">
                <button className="primary" disabled={!selectedTrend} onClick={onGenerate}>
                    Generate Mock Video
                </button>
            </div>
        </div>
        ...
        <div className="container full">
            <header className="app-header glass">
                <div className="left">
                    ...
                    <div className="brand">LitPix</div>
                </div>
                <nav className="links">
